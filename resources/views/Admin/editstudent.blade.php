                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="updateform">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="roll_no" id="roll_no" value="{{ $student->roll_no }}" autocomplete="off" required class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="username" class="text-info">Student Name :</label><br>
                                <input type="text" name="student_name" id="student_name" value="{{ $student->student_name }}" autocomplete="off" required class="form-control">
                            </div>
                            <div class="form-group">
                                ...
                                <select type="text" name="department_id" id="department_id" autocomplete="off" required class="form-control">
                                    <option value="{{ $student->department_id }}" selected disabled >{{ $student->department_name }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <option value="{{ $student->gender_id }}" selected disabled >{{ $student->gender }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="address" id="address" autocomplete="off" required class="form-control">{{ $student->address }}</textarea>
                            </div>
                            <div class="form-group">
